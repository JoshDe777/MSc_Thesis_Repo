...
During a match, a point is awarded for every rally, based on where the ball makes contact with any object other than an active player or the net, and the last team to touch the ball before this contact. A team wins a point if either the opposing team last touches a ball that lands out of bounds, or if the ball lands on the ground in the opposing team's court, regardless of last touch (\cite{fivb-2026-volleyball}).\\

There are many more rules and sensitivities to volleyball, however to mirror the comparably short timeline around this project, as well as the level of detail undergone in the implementation, these will not be covered here.\\
...
\begin{figure}[!h]	
	\centering	
	\includegraphics[width=\textwidth]{figures/feasability-training-vr.png}
	\caption[A screenshot of the Virtual Goalkeeper application from Stinson and Bowman]{A screenshot of the virtual goalkeeper application used to assess anxiety in participants in \cite{stinson-2014-feasibility}}
	\label{fig::stinson-vr-gk}
\end{figure}
...
\begin{figure}[!h]	
	\centering	
	\includegraphics[width=0.7\textwidth]{figures/virtual-rock-concert.png}
	\caption[Screenshots of the virtual rock concert in Slater et.al.]{Screenshots of the virtual concert environment used in \cite{slater-2023-sentiment}.}
	\label{fig::vr-rock-concert}
\end{figure}
...
The largest difference to the proposed study is the subject of this related work, which was to improve Presence in a virtual concert, meaning focus both in analysis and development was mainly posed on realism and comfort to make the experience as real as possible, when exploring avenues to improve on the simulation. This proposed study aims to explore Plausibility as a factor that is essential to applications in competitive sport, to avoid breaks in immersion that might take athletes out. Same studied metric but to a very different end.\\
...
\begin{figure}[!h]	
	\centering	
	\includegraphics[width=0.5\textwidth]{figures/crowds-glemarec.png}
	\caption[Crowd sentiment examples in Glémarec et.al.]{An overview of four different sentiments represented in virtual crowds, both individually and across a group, from \cite{glemarec-2021-indifferent}.}
	\label{fig::crowd-glemarec}
\end{figure}
...
In this study, the main subject of study was this notion of Presence, defined as a state of consciousness reliant on the perception of 'being there' in \gls{vr} environments and as 'a psychological state in which virtual objects are experienced as actual objects in either sensory or non-sensory ways'. This definition mirrors quite accurately the combined definition of \gls{pi}, the sense of "being there" [despite the sure knowledge it is not really the case], and \gls{psi}, the illusion that digital events are really happening.\\
...
Methodologically, this study joins the work of \cite{slater-2023-sentiment} in running a purely qualitative assessment with verbal interviews that were analysed through Nvivo 11, a ready-made tool to perform qualitative analyses of recorded interviews.\\
...
In highlighting closely related works, we find that the studies into sports-specific adoption of \gls{vr}, exemplified by \cite{stinson-2014-feasibility}, used \gls{psi}-adjacent concepts as proof-of-concepts for the viability of \gls{vr} in the specific scenario, in this case the arousal of anxiety in participants. In this pursuit, the study however does not account for the underlying factors triggering the measured anxiety, beyond the use of 'known anxiety triggers' as they are described, losing some of the larger context provided by \gls{vr}.\\
Other studies more directly tasking themselves with the analysis of Presence or \gls{psi}, such as \cite{riches-2019-factors} or \cite{slater-2023-sentiment}, have in the larger sense made use of qualitative methods to provide extensive insights into the underlying factors affecting this sentiment. These findings are undoubtedly generalisable to \gls{vr} simulations in general, however this generalisation should be studied in a sports-specific scenario, particularly one where the human interacts with the crowd as a spectated person, instead of as part of a crowd or social group.\\
Finally, a study into the realism of crowd sentiment showcased a positive use-case for considering direct participant-controlled, level-based configurations directly in-simulation for assessment, whilst also highlighting useful insights into crowd behaviour and perception. The limitations of this study for sports scenarios are notably the crowd sizes, peaking at 15, and the different relationship with spectators enjoyed by speakers and sports performers. The former do their work under the gaze of the crowd directly commanding their attention, while athletes could internally dismiss the crowd as a more distant mass of people to the tasks they complete. \\
...
In short, the combination of papers presented in this section lay out a solid foundation for further research on the interactions between a virtual crowd and a \gls{vr} user performing tasks under their eye, while still presenting limitations that open up avenues for research to address several of these at once.\\

Building upon this foundation of information to understand the aims and proceedings of this project, the next chapter will flesh out the identified research gap, and propose a research question and methodology to attempt to fill this open space.
